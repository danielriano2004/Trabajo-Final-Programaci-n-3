...
def main():
    ...
    print("====================================================")
    print("CARGANDO ASISTENTE LOCAL DE SUBNAUTICA...")
    print("====================================================")
                ...
                if "message" in update and "text" in update["message"]:
                    ...
                    if user_text == "/start":
                        ...
                        menu_funciones = (
                            ...
                            f"Tengo cargada la información de tus PDFs sobre historia, fauna, teorías y supervivencia.\n"
                            f"Puedes saludar y preguntar todo junto (ej: 'Hola, ¿dónde encuentro al Reaper Leviathan?').\n"
                            f"Respondo saludos y preguntas de cortesía.\n\n"
                        ...
                        respuesta_rag = cerebro_rag.ask(user_text)
